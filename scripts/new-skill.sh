...
echo "  3. Test triggers:  ./scripts/test-triggers.sh $SKILL_NAME"
echo "  4. Add test cases: $SKILL_DIR/evals/evals.json"
echo "  5. Run evals:      ./scripts/run-evals.sh $SKILL_NAME 1"
echo "  6. Deploy:         apm pack && apm install build/kerpo-skills-*"
